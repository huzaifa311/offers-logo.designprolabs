...
<footer class="!px-0 pt-16 pb-20 w-full">
    <div class="w-[85%] mx-auto ">
        ...
        <div class="flex justify-between md:flex-row flex-col mt-6 items-start md:gap-0 gap-10">
            <p class="md:w-[65%] text-left md:text-center text-sm text-gray-500">These Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed to accept all terms and conditions written in here. You must not use this Website if you disagree with any of these Website Standard Terms and Conditions.</p>
                ...
                <ul>
                    <li>
                        ...
                        <select name="Interested" id="packages3">
                            ...
                            <option value="AUTOMATED CONFERENCING PORTAL WEB - $5,000">Corporate Website Package - $5,000
                            </option>
...
<div style="display: none;" class="popupform2" id="popupform2">
    ...
    <p class="mt-2 text-[14px] text-[#848484] !pr-2">Get Started with Customized Logo Designs & Deliver Your Brand Message Effectively</p>
    ...
    <div class="mt-3">
        <img class="w-7" src="https://e7.pngegg.com/pngimages/972/560/png-clipart-whatsapp-computer-icons-whatsapp-text-orange.png" alt="">
      <p class="text-[13px] text-[#848484]">Discuss with our Design Expert Today!</p>
      <p class="font-bold text-[22px] text-[#FE6F19]">+1 (888) 944-7391</p>
    </div>
  </div>
